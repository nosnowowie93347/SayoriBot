...
class Help(commands.Cog):
    ...
    async def help(self, context: Context, *, input: str):
        """Shows all modules of that bot"""
    
        # !SET THOSE VARIABLES TO MAKE THE COG FUNCTIONAL!
        prefix = self.bot.config["prefix"]# ENTER YOUR PREFIX - loaded from config, as string or how ever you want!
        version =  "Newest"# enter version of your code
        
        # setting owner name - if you don't wanna be mentioned remove line 49-60 and adjust help text (line 88) 
        owner = 466778567905116170  # ENTER YOU DISCORD-ID
        owner_name = "PrincessSJ"   # ENTER YOUR USERNAME#1234
        ...
        if not input:
            ...
            try:
                owner = context.guild.get_member(owner).mention
        ...
        # trying to find matching cog and it's commands
            ...
            # yes, for-loops have an else statement, it's called when no 'break' was issued
                ...
                emb = discord.Embed(title="What's that?!",
                                    description=f"I've never heard from a module called `{input}` before :scream:",
