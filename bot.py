...
class DiscordBot(commands.Bot):
  ...
  async def status_task(self) -> None:
    """
        ...
        """
    statuses = [
        "with you!", "Starfield", "Skyrim", "Fallout 4", "Fallout: New Vegas",
        "with your heart", "with PrincessSJ!", "with humans!"
    ]
  ...
  async def setup_hook(self) -> None:
    ...
    self.database = DatabaseManager(connection=await aiosqlite.connect(
        f"{os.path.realpath(os.path.dirname(__file__))}/database/database.db"))
